...
以下は本日行いたいと考えている流れです。まず、検証の順番について、適していない箇所があれば、ご教示いただきたいです。
今日の予定
...
次に、今日中に完了するためにお二人の力をお借りしたいです。
勝山さん：ハニカム構造の背景とランダムな背景をアルファブレンド（諧調に注意して、実装）
やなぎさん：☆正解角度と予測角度の差を線グラフか棒グラフで表示させるようにする。

損失関数とその角度表示、残差構造やSebloc
